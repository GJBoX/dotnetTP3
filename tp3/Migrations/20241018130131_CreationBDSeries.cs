        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    utl_mobile = table.Column<string>(type: "character(10)", nullable: true),
                    ...
                    utl_cp = table.Column<string>(type: "character(5)", nullable: true),
                    ...
                    utl_datecreation = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_j_notation_not", x => new { x.utl_id, x.ser_id });
                    table.ForeignKey(
                        name: "FK_t_j_notation_not_t_e_serie_ser_ser_id",
                        column: x => x.ser_id,
